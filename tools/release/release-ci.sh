...
go get -u github.com/whatedcgveg/v2ray-core/...
go get -u github.com/whatedcgveg/ext/...

pushd $GOPATH/src/github.com/whatedcgveg/v2ray-core/
git checkout tags/${RELEASE_TAG}
popd

go install github.com/whatedcgveg/ext/tools/build/vbuild
