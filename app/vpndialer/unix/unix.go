...
import (
	...
	"github.com/whatedcgveg/v2ray-core/app/vpndialer"
...
//go:generate go run $GOPATH/src/github.com/whatedcgveg/v2ray-core/tools/generrorgen/main.go -pkg unix -path App,VPNDialer,Unix
